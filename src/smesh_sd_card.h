...
static inline void smesh_sd_append_warn_error_line(const char *, const char *) {}
static inline void smesh_sd_log_received_telemetry(const meshtastic_MeshPacket *, const meshtastic_Telemetry *) {}
