...
// Device
#define USERPREFS_CONFIG_DEVICE_NODE_INFO_BROADCAST_SECS 60 
...
#define USERPREFS_CONFIG_DEVICE_TELEM_UPDATE_INTERVAL 60
#define USERPREFS_ENVIRONMENT_MEASUREMENT_ENABLED 1
#define USERPREFS_ENVIRONMENT_UPDATE_INTERVAL 60 
#define USERPREFS_ENVIRONMENT_SCREEN_ENABLED 0
#define USERPREFS_POWER_MEASUREMENT_ENABLED 1
#define USERPREFS_POWER_UPDATE_INTERVAL 300

// set to be a router for consistent telemetry
